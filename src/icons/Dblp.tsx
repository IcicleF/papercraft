...
export default function DblpIcon(props: Partial<SvgIconProps>) {
    return (
        <SvgIcon width={24} height={24} viewBox='0 0 512 512' {...props}>
            <path
                d='M455.4,304.3l-45.9-171.7c0,0-2.9-11.1-13.6-6.2l-105,48.8l16.1,60l20.4,76.5l0.1,1.2c1,8.8-7.7,14.8-7.7,14.8L284.8,344
